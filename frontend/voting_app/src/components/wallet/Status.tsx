...
export const WalletStatus = () => {
    ...
    return (
        <div className="my-2 p-4 border rounded-lg bg-grey-100 dark:bg-gray-800">
            ...
            { account? (
                <div className="flex flex-col space-y-1">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">Address: <span className="font-mono">{account.address}</span></p>
                </div>
            ) : (
